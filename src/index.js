    ...
    init: function () {
        ...
        app.get('/payment/pay', function (req, res) {
            ...
            if(authCode == undefined) {
                var scriptNode = `<script>window.location = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=${process.env.WECHAT_APP_ID}&redirect_uri=${process.env.WECHAT_PAYMENT_PAGE}&response_type=code&scope=snsapi_base#wechat_redirect"</script>`;
